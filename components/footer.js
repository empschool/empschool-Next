        ...
        <div className="footer-max-width max-content-container">
          <div className="footer-container">
            ...
            <div className="footer-social-media">
              <span className="footer-text01">Siga-nos</span>
          ...
          <div className="footer-links">
            <div className="footer-container2">
              <span className="footer-text02">Empresa</span>
              <span className="footer-link">Inicio</span>
              <span className="footer-link">Quem somos</span>
              <span className="footer-link">Chat</span>
              <span className="footer-link">Blog</span>
              <span className="footer-text07 footer-link">
                <span>Politica de Privacidade</span>
                <br></br>
              </span>
            </div>
            <div className="footer-container3">
              <span className="footer-text10">Serviços</span>
              <span className="footer-link">Copywriting</span>
              <span className="footer-link">tráfego pago</span>
              <span className="footer-link">Social media</span>
              <span className="footer-link">Plano de negócios</span>
              <span className="footer-text15 footer-link">E-commerce</span>
            </div>
          </div>
        </div>
      </footer>
