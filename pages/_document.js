    ...
    return (
      <Html lang="pt-br">
        <Head>
          ...
          <link
            rel="shortcut icon"
            href="/playground_assets/slice 1 [12] [1] [1].png"
            type="icon/png"
            sizes="32x32"
          ></link>
          <link
          ...
          <noscript
            dangerouslySetInnerHTML={{
              __html:
                "</noscript><style>\n::placeholder{\ncolor: #63667066;\n}\n</style>\n<!-- Google Tag Manager -->\n<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\nnew Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\nj=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);\n})(window,document,'script','dataLayer','GTM-5D34NB5');</script>\n<!-- End Google Tag Manager -->\n<script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=346d7d3834629' async='true'></script>\n<meta name=\"adopt-website-id\" content=\"e62ff729-db6c-4252-9a58-fb57258490c5\" />\n<script src=\"//tag.goadopt.io/injector.js?website_code=e62ff729-db6c-4252-9a58-fb57258490c5\" class=\"adopt-injector\">\n</script>\n<!-- StorifyMe scripts -->\n<script type=\"text/javascript\" src=\"https://cdn.storifyme.com/static/web-components/storifyme-elements.min.js\"></script>\n<noscript>",
            }}
          ></noscript>
        </Head>
        <body>
